  ...
  template: `
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
      ...
      <div class="border-2 border-gray-300 rounded-4xl dark:border-gray-600 relative">
        ...
        <div class="flex pt-4 px-4 justify-between gap-1 items-center">
          <div class="flex flex-col gap-2">
            <h2 class="font-bold dark:text-gray-300">1GB + WhatsApp</h2>
            <div class="flex flex-col">

              <div class="flex flex-row gap-2">
                <h2 class="text-sm text-gray-500 font-bold dark:text-gray-300">Duracion:</h2>
        ...
        <div class="flex flex-row gap-2 justify-center">
          <h2 class="text-xs text-gray-500 dark:text-gray-300">Esta promo vence en:</h2>
          <h2 class="text-xs text-gray-500 dark:text-gray-300">4 Dias</h2>
        </div>
      </div>
      ...
      <div class="border-2 border-gray-300 rounded-4xl dark:border-gray-600 relative">
        ...
        <div class="flex pt-4 px-4 justify-between gap-1 items-center">
          <div class="flex flex-col gap-2">
            <h2 class="font-bold dark:text-gray-300">2GB + 10min Llamadas</h2>
            <div class="flex flex-col">
              <div class="flex flex-row gap-2">
                <h2 class="text-sm text-gray-500 font-bold dark:text-gray-300">Duracion:</h2>
        ...
        <div class="flex flex-row gap-2 justify-center">
          <h2 class="text-xs text-gray-500 dark:text-gray-300">Esta promo vence en:</h2>
          <h2 class="text-xs text-gray-500 dark:text-gray-300">2 Dias</h2>
        </div>
      </div>
      ...
      <div class="border-2 border-gray-300 rounded-4xl dark:border-gray-600 relative">
        ...
        <div class="flex pt-4 px-4 justify-between gap-1 items-center">
          <div class="flex flex-col gap-2">
            <h2 class="font-bold dark:text-gray-300">3GB (Sin Límite)</h2>
            <div class="flex flex-col">
              <div class="flex flex-row gap-2">
                <h2 class="text-sm text-gray-500 font-bold dark:text-gray-300">Duracion:</h2>
        ...
        <div class="flex flex-row gap-2 justify-center">
          <h2 class="text-xs text-gray-500 dark:text-gray-300">Esta promo vence en:</h2>
          <h2 class="text-xs text-gray-500 dark:text-gray-300">6 Horas</h2>
        </div>
      </div>
      ...
      <div class="border-2 border-gray-300 rounded-4xl dark:border-gray-600 relative">
        ...
        <div class="flex pt-4 px-4 justify-between gap-1 items-center">
          <div class="flex flex-col gap-2">
            <h2 class="font-bold dark:text-gray-300">500MB + Redes Sociales</h2>
            <div class="flex flex-col">
              <div class="flex flex-row gap-2">
                <h2 class="text-sm text-gray-500 font-bold dark:text-gray-300">Duracion:</h2>
        ...
        <div class="flex flex-row gap-2 justify-center">
          <h2 class="text-xs text-gray-500 dark:text-gray-300">Esta promo vence en:</h2>
          <h2 class="text-xs text-gray-500 dark:text-gray-300">8 Horas</h2>
        </div>
      </div>
      ...
      <div class="border-2 border-gray-300 rounded-4xl dark:border-gray-600 relative">
        ...
        <div class="flex pt-4 px-4 justify-between gap-1 items-center">
          <div class="flex flex-col gap-2">
            <h2 class="font-bold dark:text-gray-300">10GB Mensuales</h2>
            <div class="flex flex-col">
              <div class="flex flex-row gap-2">
                <h2 class="text-sm text-gray-500 font-bold dark:text-gray-300">Duracion:</h2>
        ...
        <div class="flex flex-row gap-2 justify-center">
          <h2 class="text-xs text-gray-500 dark:text-gray-300">Esta promo vence en:</h2>
          <h2 class="text-xs text-gray-500 dark:text-gray-300">15 Dias</h2>
        </div>
      </div>
      ...
      <div class="border-2 border-gray-300 rounded-4xl dark:border-gray-600 relative">
        ...
        <div class="flex pt-4 px-4 justify-between gap-1 items-center">
          <div class="flex flex-col gap-2">
            <h2 class="font-bold dark:text-gray-300">1.5GB + 5 min Llamadas</h2>
            <div class="flex flex-col">
              <div class="flex flex-row gap-2">
                <h2 class="text-sm text-gray-500 font-bold dark:text-gray-300">Duracion:</h2>
                <h2 class="text-sm text-gray-500 dark:text-gray-300">3</h2>
                <h2 class="text-sm text-gray-500 dark:text-gray-300">Dias</h2>
              </div>
            </div>
          </div>
        ...
        <div class="flex flex-row gap-2 justify-center">
          <h2 class="text-xs text-gray-500 dark:text-gray-300">Esta promo vence en:</h2>
          <h2 class="text-xs text-gray-500 dark:text-gray-300">3 Dias</h2>
        </div>
      </div>
